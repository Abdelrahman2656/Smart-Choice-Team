...
exports.startSeedingMobile = void 0;
...
const startSeedingMobile = async () => {
    ...
    try {
        ...
        const existingAsins = await Database_1.Mobile.find({ asin: { $in: validProducts.map((p) => p.asin) } }).select("asin");
        ...
        await Database_1.Mobile.bulkWrite(productOps);
...
exports.startSeedingMobile = startSeedingMobile;
